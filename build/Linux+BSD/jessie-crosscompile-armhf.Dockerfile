...
RUN apt-get download libicu52:armhf                  && dpkg --force-all -i libicu52_52.1-8+deb8u3_armhf.deb && \
    apt-get download libqt5multimedia5:armhf         && dpkg --force-all -i libqt5multimedia5_5.3.2-5_armhf.deb && \
    apt-get download libqt5multimediawidgets5:armhf  && dpkg --force-all -i libqt5multimediawidgets5_5.3.2-5_armhf.deb && \
    apt-get download libqt5positioning5:armhf        && dpkg --force-all -i libqt5positioning5_5.3.2-2_armhf.deb && \
    apt-get download libqt5sensors5:armhf            && dpkg --force-all -i libqt5sensors5_5.3.2+dfsg-2_armhf.deb && \
    apt-get download libqt5webkit5:armhf             && dpkg --force-all -i libqt5webkit5_5.3.2+dfsg-4_armhf.deb && \
    apt-get download qt5-image-formats-plugins:armhf && dpkg --force-all -i qt5-image-formats-plugins_5.3.2-2_armhf.deb && \
    apt-get download qml-module-qtquick-controls:armhf && dpkg --force-all -i qml-module-qtquick-controls_5.3.2-2_armhf.deb

#afer installing more non-qt libs
RUN apt-get download libpulse0:armhf && dpkg --force-all -i libpulse0_5.0-13_armhf.deb && \
    apt-get download libjson-c-dev:armhf && dpkg --force-all -i libjson-c-dev_0.11-4_armhf.deb && \
    apt-get download libexpat1-dev:armhf && dpkg --force-all -i libexpat1-dev_2.1.0-6+deb8u1_armhf.deb && \
    apt-get download libdbus-1-3:armhf && dpkg --force-all -i libdbus-1-3_1.8.20-0+deb8u1_armhf.deb && \
    apt-get download libglib2.0-0:armhf && dpkg --force-all -i libglib2.0-0_2.42.1-1_armhf.deb
...
RUN apt-get download libkeyutils-dev:armhf && dpkg --force-all -i libkeyutils-dev_1.5.9-5+b1_armhf.deb && \
    apt-get download libwrap0:armhf && dpkg --force-all -i libwrap0_7.6.q-25_armhf.deb

#needed by AppImageKit possibly
RUN apt-get download libacl1:armhf && dpkg --force-all -i libacl1_2.2.52-2_armhf.deb && \
    apt-get download libreadline6:armhf && dpkg --force-all -i libreadline6_6.3-8+b3_armhf.deb && \
    apt-get download libbz2-1.0:armhf && dpkg --force-all -i libbz2-1.0_1.0.6-7+b3_armhf.deb

#needed by Arch Linux
RUN apt-get download libpcre3:armhf && dpkg --force-all -i libpcre3_2%3a8.35-3.3+deb8u2_armhf.deb && \
    apt-get download libasound2-plugins:armhf && dpkg --force-all -i libasound2-plugins_1.0.28-1+b1_armhf.deb
